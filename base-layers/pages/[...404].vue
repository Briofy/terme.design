  ...
  <section class="bg-gray-50 dark:bg-gray-800 h-screen">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-sm text-center">
        <h1
          class="mb-4 text-4xl tracking-tight font-extrabold text-primary-600 dark:text-gray-100"
        >
          404 Not Found
        </h1>
        <p
          class="mb-8 font-medium text-gray-500 sm:text-2xl dark:text-gray-400"
        >

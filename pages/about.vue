<template>
    ...
    >
      <div class="max-w-4xl mx-auto">
        ...
        >
          ...
          models, algorithms, risk programs on Terme design
        </p>
      </div>
      <div
      ...
      >
        <div
          class="p-4 text-primary-700 bg-primary-100 rounded dark:bg-primary-900 dark:text-primary-300"
        >
          <h2 class="text-3xl font-extrabold leading-tight">+1 Billion</h2>
          <span class="text-primary-500 dark:text-primary-400"
            >Trading Volume</span
          >
        </div>
        <div
          class="p-4 text-teal-600 bg-teal-100 rounded dark:bg-teal-900 dark:text-teal-300"
        >
          <h2 class="text-3xl font-extrabold leading-tight">+85K</h2>
          <span class="text-teal-500 dark:text-teal-400">Items Listed</span>
        </div>
        <div
          class="p-4 text-indigo-700 bg-indigo-100 rounded dark:bg-indigo-900 dark:text-indigo-300"
        >
          <h2 class="text-3xl font-extrabold leading-tight">+1.2M</h2>
          <span class="text-indigo-500 dark:text-indigo-400"
            >Capital Management</span
          >
        </div>
        <div
          class="p-4 text-purple-700 bg-purple-100 rounded dark:bg-purple-900 dark:text-purple-300"
        >
          <h2 class="text-3xl font-extrabold leading-tight">+12K</h2>
          <span class="text-purple-500 dark:text-purple-400"
            >Collaborations</span
          >
        </div>
        <div
          class="p-4 text-green-600 bg-green-100 rounded dark:text-green-300 dark:bg-green-900"
        >
          <h2 class="text-3xl font-extrabold leading-tight">+157K</h2>
          <span class="text-green-500 dark:text-green-400">Capital Saved</span>
        </div>
      </div>
    </div>
  </section>
    ...
    >
      <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
        ...
        <p class="mb-4">
          ...
          software. Thus, Terme design was born.The team worked tirelessly day
          and night, fueled by their passion for innovation and their desire to
          make a mark in the industry. They poured their hearts and souls into
          the project, fine-tuning the software until it was ready for release.

          <span v-if="readMoreStatus">
            <br />
            Initially, they faced numerous challenges as they tried to get their
            product off the ground. They struggled to find investors and faced
            fierce competition from established trading software companies. But
            they refused to give up, believing that their creation had the
            potential to revolutionize the industry.
            <br />
            Finally, after 5 years of hard work and dedication, we launched
            Terme design. The software was an instant hit, and traders from all
            over the world flocked to it.
            <br />
            Today, Terme design is a global brand, with three major offices
            around the world. We proud of what we have achieved, and we continue
            to work tirelessly to improve our product and deliver great
            ...
            They are grateful for the opportunity to have started their business
            from the AI lab at their university, and they hope to inspire other
      ...
      <div class="grid grid-cols-2 gap-4 mt-8">
        ...
        />
        <img
          class="mt-4 w-full lg:mt-10 rounded"
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="grid gap-8 lg:grid-cols-2">
        <NuxtLink
          to="/careers"
          class="inline-flex justify-center items-center p-5 text-base font-medium text-gray-500 bg-gray-50 rounded hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white"
        >
          <svg
            class="mr-3 w-5 h-5"
            viewBox="0 0 32 32"
          ...
          <span class="w-full">Explore Terme design Open Positions</span>
          <svg
            class="ml-3 w-6 h-6"
            fill="currentColor"
            viewBox="0 0 20 20"
        ...
        >
          ...
          <span class="w-full">Get Started With Our Open APIs</span>
          <svg
            class="ml-3 w-6 h-6"
            fill="currentColor"
            viewBox="0 0 20 20"
        ...
        >
          ...
          <span class="w-full">Checkout Our Open Source Projects</span>
          <svg
            class="ml-3 w-6 h-6"
            fill="currentColor"
            viewBox="0 0 20 20"
        ...
        >
          ...
          <span class="w-full"
            >Follow On Social Networks and Blog Newsroom</span
          >
          <svg
            class="ml-3 w-6 h-6"
            fill="currentColor"
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-xl">
      ...
      >
        Focus On What Is Matter, Your Idea, Your Business
      </p>
      <div
        class="justify-center space-y-2 space-x-0 sm:space-y-0 sm:space-x-6 sm:flex"
      >
        <NuxtLink
      ...
      <div
        class="mt-6 space-y-4 md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-4 xl:gap-8 md:space-y-0 md:mb-8 md:mt-12"
      >
        <a
          href="#"
        ...
        >
          ...
          >
            ...
            />
            <path
              d="M61.3809 0.996094H56.1211V26.7296H61.3809V0.996094Z"
              fill="currentColor"
            />
            <path
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-sm text-center">
        ...
        <p class="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">
          Let`s to hear your voice, idea, and questions.
        </p>
        <NuxtLink
          to="/contact"
          class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
          >Contact</NuxtLink
        >
      </div>
    </div>

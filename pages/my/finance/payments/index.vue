    ...
    <div class="mx-auto">
      ...
      >
            ...
            >
              <form class="w-full md:max-w-sm flex-1 md:mr-4">
                ...
                <div class="relative">
                  ...
                  <input
                    type="search"
                    id="default-search"
                    class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded rounded-r-lg outline-none bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Search..."
                    required=""
                  />
                  <button
              ...
              <div class="flex items-center space-x-4">
                <div>
                  ...
                  <div
                    id="filterDropdown"
                    class="z-10 hidden p-3 bg-white rounded shadow w-56 dark:bg-gray-700"
                  >
                    <h6
                      ...
                      <li>
                        ...
                        >
                          <input
                            type="checkbox"
                            value=""
                            class="w-4 h-4 mr-2 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 dark:bg-gray-600 dark:border-gray-500"
                          />
                          In progress
                        </label>
                      </li>
                    ...
                    <h6
                      class="mt-4 mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >
                      By number of users
                    </h6>
                    <ul
        ...
        <div class="mx-4 pb-3 flex flex-wrap">
          <div
            class="hidden md:flex items-center text-sm font-medium text-gray-900 dark:text-white mr-4 mt-3"
          >
            Show only:
          </div>
          ...
          >
                ...
                <th scope="col" class="p-4">
                  <div class="flex items-center">
                    <input
                      id="checkbox-all"
                      type="checkbox"
                      class="w-4 h-4 text-primary-600 bg-gray-100 rounded border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600"
                    />
            ...
            <tbody>
              ...
              >
                ...
                >
                  <div
                    class="px-2 py-1 border dark:border-gray-600 bg-white dark:bg-gray-700 rounded text-xs font-medium inline-flex items-center"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                    ...
                    /8:00
                    <button
                      class="bg-orange-500 hover:bg-orange-700 text-white p-1 rounded-md ml-3"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewbox="0 0 24 24"
                ...
                <td
                  class="px-4 py-2 whitespace-nowrap font-medium text-gray-900 dark:text-white text-xs"
                >
                  23 Nov 2022
                </td>
                <td class="px-4 py-2">
                  <button
                    ...
                    class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                  >
                    <svg
                      class="w-5 h-5"
                      aria-hidden="true"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    7:00
                    <button
                      class="bg-green-500 hover:bg-green-700 text-white p-1 rounded-md ml-3"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewbox="0 0 24 24"

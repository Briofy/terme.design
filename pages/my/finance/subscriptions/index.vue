<template>
  <section class="bg-gray-50 dark:bg-gray-900">
    <div class="mx-auto">
      <div
        class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded"
      >
        <div class="px-4 divide-y dark:divide-gray-700">
          ...
          >
            <button
              type="button"
              class="flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
            >
              <svg
            ...
            <tbody>
              ...
              >
                ...
                >
                  <div class="flex items-center">
                    <div
                      class="w-3 h-3 mr-2 bg-green-500 border rounded-full"
                    ></div>
                    Active
                  </div>
                </td>
                ...
                >
                  <button
                    ...
                    class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                  >
                    <svg
                      class="w-5 h-5"
                      aria-hidden="true"
              ...
              >
                ...
                <td class="px-4 py-2">
                  <div
                    class="inline-flex items-center bg-indigo-100 text-indigo-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-indigo-900 dark:text-indigo-300"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-3.5 w-3.5 mr-1"
                ...
                >
                  <div class="flex items-center">
                    <div
                      class="w-3 h-3 mr-2 bg-red-500 border rounded-full"
                    ></div>
                    Inactive
                  </div>
                </td>
              ...
              >
                ...
                >
                  ...
                  >
                    <ul
                      class="py-1 text-sm text-gray-700 dark:text-gray-200"
                      aria-labelledby="dropdown-button-5"
                    >
                      <li>
                        <a
                          href="#"
              ...
              >
                ...
                >
                  ...
                  >
                    <ul
                      class="py-1 text-sm text-gray-700 dark:text-gray-200"
                      aria-labelledby="dropdown-button-6"
                    >
                      <li>
                        <a
                          href="#"
              ...
              >
                ...
                >
                  <button
                    ...
                    type="button"
                    data-dropdown-toggle="dropdown-7"
                    class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                  >
                    <svg
                      class="w-5 h-5"
                  ...
                  >
                    <ul
                      class="py-1 text-sm text-gray-700 dark:text-gray-200"
                      aria-labelledby="dropdown-button-7"
                    >
                      <li>
                        <a
                          href="#"
              ...
              >
                ...
                >
                  <button
                    id="dropdown-button-8"
                    type="button"
                    data-dropdown-toggle="dropdown-8"
                    class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                  >
                    <svg
                      class="w-5 h-5"
                  ...
                  >
                    <ul
                      class="py-1 text-sm text-gray-700 dark:text-gray-200"
                      aria-labelledby="dropdown-button-8"
                    >
                      <li>
                        <a
                          href="#"
              ...
              >
                ...
                >
                  <button
                    id="dropdown-button-9"
                    type="button"
                    data-dropdown-toggle="dropdown-9"
                    class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 rounded hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none dark:text-gray-400 dark:hover:text-gray-100"
                  >
                    <svg
                      class="w-5 h-5"
        ...
        >
          <div class="flex items-center space-x-3">
            ...
            ><select
              id="rows"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded outline-none focus:ring-primary-500 focus:border-primary-500 block py-1.5 pl-3.5 pr-6 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
            >

        ...
        >
          <div class="mb-4 space-y-4 xl:col-span-2">
            ...
            <div class="flex items-center space-x-3">
              ...
              <select
                id="time"
                class="w-48 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded outline-none focus:ring-primary-500 focus:border-primary-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
              >
                <option selectedes not repeat></option>
            ...
            <button
              type="button"
              class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
            >
              <svg
                aria-hidden="true"
            ...
            <div>
              ...
              <div class="flex items-center space-x-2">
                <button
                  type="button"
                  class="w-6 h-6 bg-purple-500 rounded"
                ></button>
                <button
                  type="button"
                ...
                <button
                  type="button"
                  class="w-6 h-6 rounded bg-primary-600"
                ></button>
                <button
                  type="button"
                  class="w-6 h-6 bg-pink-500 rounded"
                ></button>
                <button
                  type="button"
                  class="w-6 h-6 bg-teal-400 rounded"
                ></button>
                <button
                  type="button"
                  class="w-6 h-6 bg-green-400 rounded"
                ></button>
                <button
                  type="button"
                  class="w-6 h-6 bg-yellow-300 rounded"
                ></button>
                <button
                  type="button"
                  class="w-6 h-6 bg-orange-400 rounded"
                ></button>
                <button
                  type="button"
                  class="w-6 h-6 bg-red-500 rounded"
                ></button>
              </div>
            </div>
            <div>
              ...
              >
              <div
                class="mb-4 w-full bg-gray-100 rounded border border-gray-200 dark:bg-gray-600 dark:border-gray-600"
              >
                <div
                ...
                >
                  ...
                  >
                    ...
                    <div
                      class="hidden flex-wrap items-center space-x-1 sm:flex sm:pl-4"
                    >
                      <button
                        type="button"
                        class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600"
            ...
            <div>
              ...
              <div class="space-y-4 md:flex md:space-y-0 md:space-x-4">
                <div class="w-full">
                  <label for="reminder-type" class="sr-only"
                    >Reminder type</label
                  >
                  <select
                    id="reminder-type"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded outline-none focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  >
                ...
                <div class="w-full">
                  ...
                  <input
                    ...
                    class="bg-gray-50 text-sm border border-gray-300 text-gray-900 rounded outline-none focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="1"
                    required
                  />
                </div>
                <div class="w-full">
                  <label for="reminder-length-type" class="sr-only"
                    >Length</label
                  >
                  <select
            ...
            <div>
              ...
              <div class="relative">
                <input
                  type="text"
                  id="add-guests"
                  class="block p-3 pl-4 w-full text-sm text-gray-900 bg-gray-50 rounded outline-none border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"

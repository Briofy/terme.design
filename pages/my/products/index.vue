            ...
            <tbody>
                ...
                <td
                  ...
                  <div class="flex items-center space-x-4">
                    ...
                    <div
                      id="tooltip-default"
                      role="tooltip"
                      class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-90 tooltip dark:bg-gray-700">
                      Edit
                      <div class="tooltip-arrow" data-popper-arrow></div>
                    </div>

                    <button
                      data-tooltip-target="delete-tooltip-default"
                      type="button"
                      ...
                      <Icon
                        name="mdi:trash-can"
                        size="23px"
                        class="justify-center h-4 w-4" />
                    </button>
                    <div
                      id="delete-tooltip-default"
                      role="tooltip"
                      class="absolute opacity-90 z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm tooltip dark:bg-gray-700">
                      Delete
                      <div class="tooltip-arrow" data-popper-arrow></div>
                    </div>
                  </div>
              ...
              <tr
                ...
                <td
                  ...
                  <div class="flex items-center">
                    <div
                      class="h-4 w-4 rounded-full inline-block mr-2 bg-green-400"></div>
                    24
                  </div>
                </td>
                <td
              ...
              <tr
                ...
                <td
                  ...
                  <div class="flex items-center">
                    <div
                      class="h-4 w-4 rounded-full inline-block mr-2 bg-red-500"></div>
                    287
                  </div>
                </td>
                <td
              ...
              <tr
                ...
                <td
                  ...
                  <div class="flex items-center">
                    <div
                      class="h-4 w-4 rounded-full inline-block mr-2 bg-yellow-300"></div>
                    450
                  </div>
                </td>
                <td
              ...
              <tr
                ...
                <td
                  ...
                  <div class="flex items-center">
                    <div
                      class="h-4 w-4 rounded-full inline-block mr-2 bg-orange-500"></div>
                    235
                  </div>
                </td>
                <td
  ...
  <form
    ...
    <div class="grid grid-cols-2 gap-4 mt-6 sm:w-1/2">
      ...
      <button
        ...
        data-modal-toggle="delete-modal"
        class="flex items-center text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded text-sm px-3 py-2 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
        <Icon name="mdi:trash-can" size="23px" class="justify-center h-4 w-4" />
      </button>
    </div>
  </form>

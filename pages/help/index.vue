    ...
    <div class="py-8 px-4 mx-auto sm:py-16 lg:px-6">
      ...
      <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <div class="p-4 rounded shadow dark:bg-gray-800">
          <div
            class="flex justify-center items-center mb-4 w-10 h-10 rounded bg-blue-100 dark:bg-blue-900 lg:h-12 lg:w-12"
          >
            <svg
          ...
          <ul
            role="list"
            class="mb-4 space-y-3 text-gray-500 dark:text-gray-400"
          >
            <li>
        ...
        <div class="p-4 rounded shadow dark:bg-gray-800">
          ...
          <ul
            role="list"
            class="mb-4 space-y-4 text-gray-500 dark:text-gray-400"
          >
            <li>
              <a href="#" class="hover:underline"
                >How to restore your chat history</a

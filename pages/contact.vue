    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="grid gap-16 lg:grid-cols-3">
        <div class="hidden lg:block">
          ...
          <h4 class="mt-4 mb-1 font-medium text-gray-900 dark:text-white">
            Information
          </h4>
          <p
            class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500"
          >
            <a href="mailto:info@Terme design.net">info@Terme design.net</a>
          </p>
          <h4 class="mt-4 mb-1 font-medium text-gray-900 dark:text-white">
            Support
          </h4>
          <p
            class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500"
          >
            <a href="mailto:support@Terme design.net"
              >support@Terme design.net</a
            >
          </p>
          <h4 class="mt-4 mb-1 font-medium text-gray-900 dark:text-white">
            Sales
          ...
          <p
            class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500"
          >
            <a href="mailto:sales@Terme design.net">sales@Terme design.net</a>
          </p>
          <h3
            class="mt-5 mb-4 text-lg font-semibold text-gray-900 dark:text-white"
          >
          ...
          <address class="text-sm font-normal text-gray-500 non-italic">
            ...
            <br />Canary Wharf, London E14 5NR
          </address>
          <h4 class="mt-4 mb-1 font-medium text-gray-900 dark:text-white">
            Germany
          </h4>
          <address class="text-sm font-normal text-gray-500 non-italic">
            ...
            <br />Potsdamer Platz, Berlin 10785
          </address>
        </div>
